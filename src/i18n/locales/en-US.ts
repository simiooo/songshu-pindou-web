export default {
  ...
  editor: {
    tools: 'Tools',
    brush: 'Brush',
    brushHint: 'Click to draw single bead',
    eraser: 'Eraser',
    eraserHint: 'Erase bead to blank',
    fill: 'Fill',
    fillHint: 'Fill contiguous same-color area',
    selection: 'Selection',
  ...
  upload: {
    ...
    gridSizeDescription: 'Choose the grid size for your bead canvas. This determines the level of detail in the final pattern.',
    confirmGridSize: 'Confirm and Start Generation',
    selectedGridSize: 'Selected Grid Size',
    changeGridSize: 'Change',
    gridSizeSmall: 'Mini',
    gridSizeMedium: 'Medium',
    gridSizeLarge: 'Large',
    gridSizeXLarge: 'Extra Large',
    gridSizeXXLarge: 'XXL',
    gridSizeHuge: 'Huge',
  },
  pixelation: {
